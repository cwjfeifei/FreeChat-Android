...
package com.ti4n.freechat.bip44forandroidlibrary.core;
...
import com.ti4n.freechat.bip44forandroidlibrary.crypto.EncryptableItem;
import com.ti4n.freechat.bip44forandroidlibrary.crypto.EncryptedData;
import com.ti4n.freechat.bip44forandroidlibrary.crypto.KeyCrypter;
import com.ti4n.freechat.bip44forandroidlibrary.crypto.KeyCrypterException;
import com.ti4n.freechat.bip44forandroidlibrary.utils.LinuxSecureRandom;
...
public class ECKey implements EncryptableItem {
    ...
    public static ECPoint compressPoint(ECPoint point) {
        return getPointWithCompression(point);
    }
    ...
    private static ECPoint getPointWithCompression(ECPoint point) {
    ...
    public static ECKey fromPrivate(BigInteger privKey) {
        ...
        return new ECKey(privKey, getPointWithCompression(point));
    }
     ...
     */
    @Deprecated
    public ECKey(@Nullable BigInteger privKey, @Nullable byte[] pubKey) {
        ...
        if (pubKey == null) {
            ...
            ECPoint point = publicPointFromPrivate(privKey);
            point = getPointWithCompression(point);
    ...
    private static ECKey extractKeyFromASN1(byte[] asn1privkey) {
        ...
        try {
            ...
            ECKey key = new ECKey(privkey, (byte[]) null);
